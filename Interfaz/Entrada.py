...
N_planetas=np.genfromtxt("N_planetas.txt",delimiter=",",dtype=float)
p=N_planetas[0]                #numero de planetas a graficar
av=N_planetas[1]         #celovidad a la que se agranda la grafica
t=N_planetas[2]                #tamaño de la grafica inicial o por defecto
